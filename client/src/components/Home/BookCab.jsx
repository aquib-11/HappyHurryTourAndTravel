...
const BookCab = () => {
  ...
  return (
    ...
    <div className="container my-10   ">
      <h1 className="font-sans font-bold leading-tight text-center text-[var(--bs-white)] my-4">Book your Online Cab</h1>
      ...
      <div className="flex flex-col gap-4 items-center flex-1 p-6 md:order-2 order-1">
  ...
  <p className="text-gray-300 font-sans text-lg mt-4">
    Whether it's a one-way trip or an exciting road trip, we’ve got you covered. 
    Choose your ride, book online, and enjoy a seamless travel experience with 
    Happy Hurry Cab Services. Your journey begins here!
  </p>
</div>
</div>
    </div>
