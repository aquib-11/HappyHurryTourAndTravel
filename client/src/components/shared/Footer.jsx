      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h2 className="text-xl font-bold mb-4 text-[var(--bs-white)]">Booking</h2>
          ...
          {/* Quick Links */}
          <div className="col-span-1">
            <h2 className="text-xl font-bold mb-4 text-[var(--bs-white)]">Quick Links</h2>
            <ul className="space-y-3">
          ...
          {/* Social Media */}
          <div className="col-span-1">
            <h2 className="text-xl font-bold mb-4 text-[var(--bs-white)]">Social Media</h2>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-[var(--bs-text)] transition-colors duration-300">
                <FaFacebook size={24} />
              </a>
              <a href="#" className="text-gray-400 hover:text-[var(--bs-text)] transition-colors duration-300">
                <FaTwitter size={24} />
