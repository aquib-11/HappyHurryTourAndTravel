...
const DesktopNav = () => {
  ...
  return (
    ...
    >
      ...
      `}>
        {isExpanded ? (
          ...
          ">
            ...
            <span className="font-semibold text-gray-800 text-lg">AppName</span>
          </div>
        ) : (
          <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center">
            <span className="text-white font-bold text-xl">A</span>
      ...
      >
        {isExpanded 
          ? <ChevronLeft className="w-6 h-6 text-gray-600 transition-transform hover:scale-110" /> 
          : <ChevronRight className="w-6 h-6 text-gray-600 transition-transform hover:scale-110" />
        }
      </div>
    </nav>
  );
