...
export const editTourPackageLoader = async ({ params }) => {
  try {
    ...
    return (data = {
      ...
      hotels: response1.data.hotels,
      tourPackage: response2.data._package,
    });
  } catch (error) {
    console.log({ error });
    return error;
  ...
  return (
    <div>
      ...
      <Form method="post" encType="multipart/form-data" className="space-y-4">
        ...
        <div>
          <label>Image:</label>
          <input type="file" name="image" className="inputText" />
        </div>
        <div>
          <div>
